...
<head>
    ...
    <head>
        ...
        <!-- <![endif]-->
        <!--[if IE]>
        <script type="<%=request.getContextPath()%>/bootstrap/text/javascript">window.jQuery || document.write("<script src='assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
        <![endif]-->
        <script type="<%=request.getContextPath()%>/bootstrap/text/javascript">
        ...
        <!--[if lte IE 8]>
        <script src="<%=request.getContextPath()%>/bootstrap/assets/js/excanvas.min.js"></script>
        <![endif]-->
        <script src="<%=request.getContextPath()%>/bootstrap/assets/js/ace-elements.min.js"></script>
        <script src="<%=request.getContextPath()%>/bootstrap/assets/js/ace.min.js"></script>
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            <a href="#" class="navbar-brand">
                <small>
                    <%--<img src="<%=request.getContextPath()%>/bootstrap/images/logo.png" width="470px">--%>
                </small>
            </a><!-- /.brand -->
        </div><!-- /.navbar-header -->
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
            ...
            <div id="menu_style" class="menu_style">
                <ul class="nav nav-list" id="nav_list">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="zs/transaction.jsp" title="交易信息"  class="iframeurl"><i class="icon-double-angle-right"></i>交易信息</a></li>
                            <li class="home"><a href="javascript:void(0)" name="zs/Orderform.jsp" title="订单管理"  class="iframeurl"><i class="icon-double-angle-right"></i>订单管理</a></li>
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-bookmark"></i><span class="menu-text"> 范文管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
        ...
        <div class="main-content">
            ...
            <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="<%=request.getContextPath()%>/home.html"></iframe>
