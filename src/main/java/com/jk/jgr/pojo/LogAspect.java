...
import com.jk.jgr.rabbitmq.Sender;
...
public class LogAspect {
	   ...
	   private  MongoTemplate    mongoTemplate;
		...
		public void setMongoTemplate(MongoTemplate mongoTemplate) {
		 ...
		 @Pointcut("execution(* com.jk.*.service..*.query*(..))")
		  ...
		  * 添加业务逻辑方法切入点
		  */
		 @Pointcut("execution(* com.jk.*.service..*.add*(..))")
		  ...
		  * 修改业务逻辑方法切入点
		  */
		 @Pointcut("execution(* com.jk.*.service..*.update*(..))")
		  ...
		  * 删除业务逻辑方法切入点
		  */
		 @Pointcut("execution(* com.jk.*.service..*.delete*(..))")
